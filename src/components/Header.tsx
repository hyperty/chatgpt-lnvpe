          ...
          <Show
            ...
            fallback={
              <>
                ...
                <span class="ml-1 font-extrabold text-slate-7 dark:text-slate" style="margin-left: 8px;">
                  for
                </span>
                <span class="text-transparent font-extrabold bg-clip-text bg-gradient-to-r dark:from-blue-300 from-blue-400 dark:to-green-400 to-green-400" style="margin-left: 10px;">
                  LNVPE
                </span>
              </>
            }
